import 'package:flutter/material.dart';
  ...
  TextStyle getTextStyleTitle(BuildContext context, Color? colors) {
    ...
    //para tablets
    MediaQuery.of(context).size.width * (MediaQuery.of(context).orientation == Orientation.portrait ? .05 : 0.03);
 ...
 TextStyle getTextStyleTitleHome(BuildContext context, Color? colors) {
    ...
    double fontSize = MediaQuery.of(context).size.height < 960 && MediaQuery.of(context).size.width <900  ?
    //para celulares
      MediaQuery.of(context).size.width * (MediaQuery.of(context).orientation == Orientation.portrait ? .06: 0.03):
    //para tablets
    MediaQuery.of(context).size.width * (MediaQuery.of(context).orientation == Orientation.portrait ? .04: 0.025);
